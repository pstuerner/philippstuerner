...
>>> X=np.array([${[
                ...math.round(X._data[1].slice(0, 5), 2),
                ...["..."],
            ].toString()}])
>>> y=np.array([${[
                ...math.round(y._data[0].slice(0, 5), 2),
                ...["..."],
            ].toString()}])
...
>>> theta_hat
array([${theta0_best.toFixed(2)}, ${theta1_best.toFixed(
                2
            )}, ${theta2_best.toFixed(2)}])`
        );
        ...
        let lineData = [
                {
                    v: yHat.valueOf()[0].map(function (d, i) {
                        return {
                            ...
                            y: _.clamp(
                                d,
                                yExtent[0] - math.abs(yExtent[0] * 0.5),
                                yExtent[1] + math.abs(yExtent[0] * 0.5)
                            ),
                        };
                    }),
                },
