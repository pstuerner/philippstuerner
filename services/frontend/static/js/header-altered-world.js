...
"use strict";
{
	...
	const canvas = {
		init() {
            ...
            const div = document.querySelector("#altered-world-container");
			this.elem = document.createElement("canvas");
            div.appendChild(this.elem);
            this.width = this.elem.width = div.offsetWidth;
			this.height = this.elem.height = div.offsetHeight;
	...
	async function run() {
        ...
        d3.select("#altered-world-container")
        .select("canvas")
        .transition()
            .duration(2500)
            .delay(1000)
            ...
            .on("end", function () {
                ...
                perlin = new Noise(randomFloat(0.5,5));
                ctx.lineWidth = randomFloat(0.5,2.5);
                ctx.globalAlpha = randomFloat(0.025,0.02);
                run();
            })
        .transition()
            .duration(2500)
