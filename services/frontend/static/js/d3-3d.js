(function (global, factory) {
    ...
    function point(points, options, point, angles) {
        for (var i = points.length - 1; i >= 0; i--) {
            ...
            p.rotated = rotateRzRyRx(
                { x: point.x(p), y: point.y(p), z: point.z(p) },
                angles
            );
    ...
    function line(lines, options, point, angles) {
        for (var i = lines.length - 1; i >= 0; i--) {
            ...
            p1.rotated = rotateRzRyRx(
                { x: point.x(p1), y: point.y(p1), z: point.z(p1) },
                angles
            );
            p2.rotated = rotateRzRyRx(
                { x: point.x(p2), y: point.y(p2), z: point.z(p2) },
                angles
            );
    ...
    function plane(planes, options, point, angles) {
        for (var i = planes.length - 1; i >= 0; i--) {
            ...
            p3.rotated = rotateRzRyRx(
                { x: point.x(p3), y: point.y(p3), z: point.z(p3) },
                angles
            );
            p4.rotated = rotateRzRyRx(
                { x: point.x(p4), y: point.y(p4), z: point.z(p4) },
                angles
            );
    ...
    function _3d() {
        ...
        _3d.x = function (_) {
            return arguments.length
                ? ((x$1 = typeof _ === "function" ? _ : +_), _3d)
                : x$1;
        };

        _3d.y = function (_) {
            return arguments.length
                ? ((y$1 = typeof _ === "function" ? _ : +_), _3d)
                : y$1;
        };

        _3d.z = function (_) {
            return arguments.length
                ? ((z$1 = typeof _ === "function" ? _ : +_), _3d)
                : z$1;
        };
